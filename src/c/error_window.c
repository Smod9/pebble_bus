...
void error_window_show(char *errorText){
  ...
  //Make sure this isnt a null pointer
...
void error_graphics_proc(Layer *layer, GContext *ctx){
  ...
  graphics_draw_text(ctx, currentErrorText[0], fonts_get_system_font(FONT_KEY_GOTHIC_24_BOLD), GRect(15,50,144,50), GTextOverflowModeWordWrap,GTextAlignmentCenter, NULL);

//   graphics_context_set_stroke_color(ctx, GColorBlue);
//   graphics_context_set_stroke_width(ctx, 3);
//   graphics_draw_line(ctx, GPoint(10,30), GPoint(124, 138));
//   graphics_draw_line(ctx, GPoint(10,138), GPoint(124, 30));
}
